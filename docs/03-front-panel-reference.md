...
| **sens.** | 1 of the 7 | An analog attenuator on the level-detect input (one of the codec's ADC channels); its job follows the red AUTO CONTROL switch. **All sounds:** no function. **Center / next sound:** auto-capture **threshold** — fully CCW disables auto triggering (LED dark); raising it lets quieter material trigger. |
